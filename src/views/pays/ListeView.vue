...
<div class="card-body table-responsive">
      <table class="table text-light">
        ...
        <tbody>
          <tr v-for="pays in filterByName" :key="pays.id">
            <td>
              <form>
                <div class="input-group">
                  <div class="input-group-prepend">
                  ...
                  <button class="btn btn-light" type="button" @click.prevent="uptadePays(pays)"
                    title="Modification">
                    <i class="fa fa-save fa-lg"></i>
                  </button>
                  <button class="btn btn-light" type="button" @click.prevent="deletePays(pays)" title="Suppression"
                  >
